                    ...
                    @foreach ($kartuKeluarga as $row)
                      <tr>
                        ...
                        <td>
                          ...
                          <a data-id_kk="{{ $row->id_kk }}" data-status_tempat_tinggal="{{ $row->status_tempat_tinggal }}" class="editStatusTempatTinggal btn btn-block btn-outline-info btn-flat">Update Status</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
